          ...
          <div className="flex-1">
            ...
            {activeTab === 'links' && (
              <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {series.watch_links.netflix && (
                        <a href={series.watch_links.netflix} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 bg-red-600 hover:bg-red-700 rounded-lg transition font-semibold">
                      ...
                      {series.watch_links.prime && (
                        <a href={series.watch_links.prime} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg transition font-semibold">
                          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      {series.watch_links.hotstar && (
                        <a href={series.watch_links.hotstar} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-lg transition font-semibold">
                          <span className="text-xl">⭐</span>
                          JioHotstar
                        </a>
                      )}
                      {series.watch_links.zee5 && (
                        <a href={series.watch_links.zee5} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded-lg transition font-semibold">
                          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                ...
                {/* Music Composer */}
                {series.composer_name && (
                  <div>
                    <h3 className="text-xl font-bold mb-3">Music by {series.composer_name}</h3>
                    {series.composer_links && (series.composer_links.spotify || series.composer_links.apple_music || series.composer_links.youtube_music) && (
                      <div className="flex flex-wrap gap-3">
                        {series.composer_links.spotify && (
                          <a
                            href={series.composer_links.spotify}
                            target="_blank"
                            rel="noopener noreferrer"
                        ...
                        {series.composer_links.apple_music && (
                          <a
                            href={series.composer_links.apple_music}
                            target="_blank"
                            rel="noopener noreferrer"
                        ...
                        {series.composer_links.youtube_music && (
                          <a
                            href={series.composer_links.youtube_music}
                            target="_blank"
                            rel="noopener noreferrer"
