          ...
          <div className="flex-1">
            ...
            {activeTab === 'links' && (
              <div className="space-y-8">
                ...
                {movie.composer_name && (
                  <div>
                    <h3 className="text-xl font-bold mb-3">Music by {movie.composer_name}</h3>
                    {movie.composer_links && (movie.composer_links.spotify || movie.composer_links.apple_music || movie.composer_links.youtube_music) && (
                      <div className="flex flex-wrap gap-3">
                        {movie.composer_links.spotify && (
                          <a
                            href={movie.composer_links.spotify}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 px-4 py-2 bg-green-600 hover:bg-green-700 rounded-lg transition"
                          >
                        ...
                        {movie.composer_links.apple_music && (
                          <a
                            href={movie.composer_links.apple_music}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 px-4 py-2 bg-pink-600 hover:bg-pink-700 rounded-lg transition"
                          >
                        ...
                        {movie.composer_links.youtube_music && (
                          <a
                            href={movie.composer_links.youtube_music}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 px-4 py-2 bg-red-600 hover:bg-red-700 rounded-lg transition"
                          >
