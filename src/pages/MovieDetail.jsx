          ...
          <div className="w-full max-w-4xl">
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              <button
                ...
                className="w-12 h-12 rounded-full bg-white/10 backdrop-blur border border-white/20 flex items-center justify-center hover:bg-white/20 transition-all duration-200"
              >
            ...
            <div className="overflow-x-auto scrollbar-hide">
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-16 h-16 rounded-full bg-[#3ba7ff] flex items-center justify-center transition-all duration-300 group-hover:scale-110 shadow-[0_0_24px_rgba(59,167,255,0.5)]">
          ...
          <section>
            ...
            <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide snap-x snap-mandatory">
              {movie.cast.slice(0, 15).map((c) => (
                ...
                >
                  <div className="w-[80px] md:w-[88px] h-[80px] md:h-[88px] rounded-full overflow-hidden bg-white/5 border border-white/10 mb-2 transition-all duration-200 group-hover:scale-105 group-hover:border-[#3ba7ff]/50">
