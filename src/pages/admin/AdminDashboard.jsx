...
const AdminDashboard = () => {
  ...
  const loadStats = async () => {
    const [movies, persons, users, banners] = await Promise.all([
  ...
  return (
    <AdminLayout title="Admin Dashboard" subtitle="Quick overview of your content library.">
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">          <div className="glass-card p-5 rounded-2xl hover:scale-[1.02] transition">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            </Link>            <Link to="/admin/add-person" className="glass-card p-5 rounded-2xl hover:bg-white/5 hover:scale-[1.02] transition">
            ...
            </Link>            <Link to="/admin/manage-collections" className="glass-card p-5 rounded-2xl hover:bg-white/5 hover:scale-[1.02] transition">
