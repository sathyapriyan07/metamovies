      ...
      <div className="glass-card rounded-2xl p-4 md:p-6 pb-24 md:pb-12">
        ...
        {loading ? (
          ...
          <div className="grid gap-3">
            {videos.map((video) => (
              <div key={video.id} className="glass-card rounded-2xl border border-white/10 backdrop-blur-md hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-250">
                ...
                <div className="px-4 pb-4 flex flex-wrap gap-2">
                  ...
                  <button
                    ...
                    className={`px-3 py-2 hover:scale-105 rounded-lg text-xs font-medium shadow-md transition-all duration-200 ${video.is_featured ? 'bg-green-600/70 hover:bg-green-600' : 'bg-gray-600/60 hover:bg-gray-600'}`}
                  >
