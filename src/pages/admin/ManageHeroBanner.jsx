  ...
  return (
    <AdminLayout title="Hero Banner" subtitle="Curate the hero carousel content.">
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="lg:w-1/3 w-full bg-[#1a1a1a] border border-gray-800 rounded-md p-4">
          <h2 className="text-lg font-semibold mb-3">Add New Banner</h2>
          <div className="flex gap-2 mb-4">
            <input
              ...
              placeholder="Search..."
              className="flex-1 bg-[#1a1a1a] border border-gray-800 rounded-md px-3 py-2 text-sm focus:outline-none focus:border-[#F5C518]"
            />
          ...
          {searchResults.length > 0 && (
            <div className="space-y-2 max-h-96 overflow-y-auto">
              {searchResults.map((item) => (
                <div key={item.id} className="flex items-center gap-3 p-3 bg-[#111] border border-gray-800 rounded-md">
                  <img loading="lazy"
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-[#F5C518] text-black rounded-md text-sm"
                  >
                    Add
                  </button>
                </div>
        ...
        <div className="lg:w-2/3 w-full bg-[#1a1a1a] border border-gray-800 rounded-md p-4">
          <h2 className="text-lg font-semibold mb-3">Current Banners ({banners.length})</h2>
          <div className="space-y-3">
            {banners.map((banner) => {
              const content = banner.movie;
              return (
                <div key={banner.id} className="flex items-center gap-4 bg-[#111] border border-gray-800 rounded-md p-3 justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="w-16 bg-[#1a1a1a] border border-gray-800 rounded-md px-2 py-1 text-sm"
                    />
                    <button
                    ...
                    <button
                      ...
                      className="px-3 py-1 bg-[#2a2a2a] rounded-md text-sm text-white"
                    >
                      Delete
                    </button>
                  </div>
